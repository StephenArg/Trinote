var TipTapCallout = (() => {
  ...
  // callout-entry.mjs
  var callout_entry_exports = {};
  __export(callout_entry_exports, {
    Callout: () => Callout
  });
  ...
  // callout-entry.mjs
  var ADMONITION_TYPES = ["note", "tip", "important", "caution", "warning"];
  var Callout = Node2.create({
    ...
    addCommands() {
      return {
        insertCallout: (type) => ({ commands: commands2 }) => {
        ...
        wrapInCallout: (type) => ({ commands: commands2 }) => {
          const t = ADMONITION_TYPES.includes(type) ? type : "note";
          return commands2.wrapIn(this.name, { type: t });
        },
        setCalloutType: (type) => ({ commands: commands2 }) => {
          const t = ADMONITION_TYPES.includes(type) ? type : "note";
          return commands2.updateAttributes(this.name, { type: t });
        }
      };
    }
  });
  return __toCommonJS(callout_entry_exports);
})();
