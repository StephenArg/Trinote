var TipTapListStyles = (() => {
  ...
  // list-styles-entry.mjs
  var list_styles_entry_exports = {};
  __export(list_styles_entry_exports, {
    TriliumBulletList: () => TriliumBulletList,
    TriliumOrderedList: () => TriliumOrderedList
  });
  ...
  var TriliumBulletList = BulletList.extend({
    addAttributes() {
      return {
        listStyleType: {
          default: null,
  ...
  var TriliumOrderedList = OrderedList.extend({
    addAttributes() {
      return {
        start: {
          default: 1,
  ...
  return __toCommonJS(list_styles_entry_exports);
})();
