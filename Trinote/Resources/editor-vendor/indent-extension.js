var TipTapIndent = (() => {
  ...
  // indent-entry.mjs
  var indent_entry_exports = {};
  __export(indent_entry_exports, {
    Indent: () => Indent,
    default: () => indent_entry_default
  });
    ...
    addCommands() {
      const applyIndent = (delta) => ({ state, dispatch }) => {
        ...
        state.doc.nodesBetween(from, to, (node, pos) => {
          ...
          if (next !== current) {
            tr = tr.setNodeMarkup(pos, void 0, { ...node.attrs, indent: next });
            changed = true;
          }
        });
  ...
  var indent_entry_default = Indent;
  return __toCommonJS(indent_entry_exports);
})();
