var TipTapTriliumFontSize = (() => {
  ...
  // font-size-entry.mjs
  var font_size_entry_exports = {};
  __export(font_size_entry_exports, {
    TriliumFontSize: () => TriliumFontSize
  });
  ...
  // font-size-entry.mjs
  var SIZES = ["tiny", "small", "big", "huge"];
  var TriliumFontSize = Mark2.create({
    ...
    addCommands() {
      return {
        setTriliumFontSize: (size) => ({ commands: commands2 }) => {
          if (!SIZES.includes(size)) return false;
          return commands2.setMark(this.name, { size });
        },
        unsetTriliumFontSize: () => ({ commands: commands2 }) => commands2.unsetMark(this.name)
      };
    }
  });
  return __toCommonJS(font_size_entry_exports);
})();
