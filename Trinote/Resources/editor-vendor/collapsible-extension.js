var TipTapCollapsible = (() => {
  ...
  var collapsible_entry_exports = {};
  __export(collapsible_entry_exports, {
    Collapsible: () => Collapsible,
    CollapsibleSummary: () => CollapsibleSummary
  });
  ...
  var Collapsible = Node2.create({
    ...
    addCommands() {
      return {
        insertCollapsible: () => ({ commands: commands2 }) => commands2.insertContent({
          type: this.name,
          attrs: { open: true },
          content: [{ type: "collapsibleSummary" }, { type: "paragraph" }]
        }),
        wrapInCollapsible: () => ({ state, dispatch }) => {
        ...
        toggleCollapsibleOpen: () => ({ state, dispatch }) => {
          ...
          for (let d = $from.depth; d > 0; d--) {
            ...
            if (dispatch) {
              dispatch(
                state.tr.setNodeMarkup($from.before(d), void 0, {
                  ...node.attrs,
      ...
      return ({ node, getPos, editor }) => {
        ...
        const toggleOpen = (next) => {
          ...
          editor.view.dispatch(
            editor.state.tr.setNodeMarkup(pos, void 0, { ...current.attrs, open: next })
          );
        };
        const onClick = (e) => {
        ...
        return {
          dom: details,
          contentDOM: details,
          ignoreMutation: (mutation) => mutation.type === "attributes" && mutation.attributeName === "open",
          update: (updated) => {
  ...
  return __toCommonJS(collapsible_entry_exports);
})();
