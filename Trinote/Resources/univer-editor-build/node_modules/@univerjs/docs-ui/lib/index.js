import { BaselineOffset, BlockType, BooleanNumber, BuildTextUtils, COLORS, ColorKit, CommandType, CustomRangeType, DEFAULT_EMPTY_DOCUMENT_VALUE, DEFAULT_STYLES, DOCS_FORMULA_BAR_EDITOR_UNIT_ID_KEY, DOCS_NORMAL_EDITOR_UNIT_ID_KEY, DOCS_ZEN_EDITOR_UNIT_ID_KEY, DOC_RANGE_TYPE, DashStyleType, DataStreamTreeNodeType, DataStreamTreeTokenType, DependentOn, Direction, Disposable, DisposableCollection, DocumentFlavor, DrawingTypeEnum, EDITOR_ACTIVATED, FOCUSING_COMMENT_EDITOR, FOCUSING_COMMON_DRAWINGS, FOCUSING_DOC, FOCUSING_EDITOR_STANDALONE, FOCUSING_UNIVER_EDITOR, HorizontalAlign, ICommandService, IConfigService, IConfirmService, IContextService, ILogService, IUndoRedoService, IUniverInstanceService, Inject, Injector, InterceptorManager, JSONX, LRUMap, LocaleService, MemoryCursor, NAMED_STYLE_MAP, NamedStyleType, ObjectRelativeFromH, ObjectRelativeFromV, PAGE_SIZE, PAPER_TYPES, PRESET_LIST_TYPE, PageOrientType, Plugin, PositionedObjectLayoutType, PresetListType, QuickListTypeMap, RANGE_DIRECTION, Rectangle, RedoCommandId, RxDisposable, SHEET_EDITOR_UNITS, SliceBodyType, SpacingRule, TableAlignmentType, TableRowHeightRule, TableSizeType, TableTextWrapType, TextX, TextXActionType, ThemeService, Tools, UndoCommandId, UniverInstanceType, UpdateDocsAttributeType, VerticalAlign, checkForSubstrings, createIdentifier, createInterceptorKey, createInternalEditorID, debounce, deepCompare, fromEventSubject, generateRandomId, getBodySlice, getPlainText, isCommentEditorID, isInternalEditorID, merge, mergeOverrideWithDependencies, normalizeBody, sequenceExecuteAsync, skipParseTagNames, toDisposable, touchDependencies } from "@univerjs/core";
...
import { CURSOR_TYPE, DeviceInputEventType, DocBackground, DocumentEditArea, DocumentSkeletonPageType, Documents, GlyphType, IRenderManagerService, Layer, Liquid, NORMAL_TEXT_SELECTION_PLUGIN_STYLE, PageLayoutType, Path, Rect, RegularPolygon, ScrollBar, ScrollTimer, Shape, TRANSFORM_CHANGE_OBSERVABLE_TYPE, UniverRenderEnginePlugin, Vector2, Viewport, getColor, getLastColumn, getLastLine, getNumberUnitValue, getOffsetRectForDom, getPageFromPath, getParagraphByGlyph, getSystemHighlightColor, getTableIdAndSliceIndex, hasListGlyph, isFirstGlyph, isIndentByGlyph, lineIterator, parseDataStreamToTree, pixelToPt, ptToPixel, pxToNum } from "@univerjs/engine-render";
...
import { AlignTextBothIcon, CatalogueIcon, DeleteIcon, DocSettingIcon, DownIcon, H1Icon, H2Icon, H3Icon, H4Icon, H5Icon, HorizontallyIcon, LeftIcon, LeftJustifyingIcon, RightJustifyingIcon, TextTypeIcon, TodoListDoubleIcon } from "@univerjs/icons";
...
const DeleteLeftCommand = {
	...
	handler: async (accessor) => {
		...
		if (isFirstGlyph(curGlyph) && preGlyph !== curGlyph && (isBullet === true || isIndent === true) && collapsed) {
...
const OrderListCommand = {
	...
	handler: (accessor, params) => {
		...
		return commandService.syncExecuteCommand(ListOperationCommand.id, { listType: PresetListType.ORDER_LIST });
	}
};
	...
	const textX = BuildTextUtils.selection.replace({
		...
		body: {
			...
			paragraphs: [{
				...
				bullet: {
					listType,
					listId: ((_paragraph$bullet2 = paragraph.bullet) === null || _paragraph$bullet2 === void 0 ? void 0 : _paragraph$bullet2.listType) === listType ? paragraph.bullet.listId : generateRandomId(6),
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", { children: localeService.t("headerFooter.headerTopMargin") }), /* @__PURE__ */ jsx(InputNumber, {
				...
				})] }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", { children: localeService.t("headerFooter.footerBottomMargin") }), /* @__PURE__ */ jsx(InputNumber, {
					className: "univer-mt-1.5 univer-w-4/5",
					min: 0,
					max: 200,
					precision: 1,
...
function getFontStyleAtCursor(accessor) {
	...
	const paragraph = getParagraphStyleAtCursor(accessor);
	const namedStyle = (paragraph === null || paragraph === void 0 || (_paragraph$paragraphS7 = paragraph.paragraphStyle) === null || _paragraph$paragraphS7 === void 0 ? void 0 : _paragraph$paragraphS7.namedStyleType) ? NAMED_STYLE_MAP[paragraph === null || paragraph === void 0 || (_paragraph$paragraphS8 = paragraph.paragraphStyle) === null || _paragraph$paragraphS8 === void 0 ? void 0 : _paragraph$paragraphS8.namedStyleType] : null;
...
let DocParagraphMenuService = class DocParagraphMenuService extends Disposable {
	...
	_init() {
		...
		this.disposeWithMe(combineLatest([this._docEventManagerService.hoverParagraphRealTime$, this._docEventManagerService.hoverParagraphLeft$]).pipe(throttleTime(16)).subscribe(([p, left]) => {
...
const ParagraphMenu = ({ popup }) => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(icon.component, { className: "univer-size-4 univer-text-gray-900 dark:!univer-text-white" }), /* @__PURE__ */ jsx(DownIcon, { className: "univer-size-3 univer-text-gray-600 dark:!univer-text-gray-200" })]
...
const useFirstParagraphIndentSpaceAbove = (paragraph) => {
	...
	const [spaceAbove, setSpaceAboveInternal] = useState(() => {
		...
		const firstParagraph = paragraph[0];
		if (!firstParagraph) return 0;
		return getNumberUnitValue((_firstParagraph$parag7 = firstParagraph.paragraphStyle) === null || _firstParagraph$parag7 === void 0 ? void 0 : _firstParagraph$parag7.spaceAbove, 0);
	});
...
const useFirstParagraphSpaceBelow = (paragraph) => {
	...
	const [spaceBelow, setSpaceBelowInternal] = useState(() => {
		...
		const firstParagraph = paragraph[0];
		if (!firstParagraph) return 0;
		return getNumberUnitValue((_firstParagraph$parag8 = firstParagraph.paragraphStyle) === null || _firstParagraph$parag8 === void 0 ? void 0 : _firstParagraph$parag8.spaceBelow, 0);
	});
...
const menuSchema = {
	...
	[RibbonInsertGroup.MEDIA]: { [TABLE_MENU_ID]: {
		order: 2,
...
function DocFooter() {
	const univerInstanceService = useDependency(IUniverInstanceService);
	if (useObservable(() => univerInstanceService.getCurrentTypeOfUnit$(UniverInstanceType.UNIVER_SHEET), void 0, void 0, [])) return null;
...
const DocCreateTableConfirm = ({ handleRowColChange, tableCreateParams }) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", { children: localeService.t("toolbar.table.rowCount") }), /* @__PURE__ */ jsx(InputNumber, {
			...
			className: "univer-flex univer-items-center univer-gap-2",
			children: [/* @__PURE__ */ jsx("span", { children: localeService.t("toolbar.table.colCount") }), /* @__PURE__ */ jsx(InputNumber, {
				className: "univer-w-28",
				min: 1,
				max: 20,
				precision: 0,
...
let DocClipboardController = class DocClipboardController extends RxDisposable {
	...
	_initLegacyPasteCommand() {
		...
		(_this$_docSelectionRe = this._docSelectionRenderService) === null || _this$_docSelectionRe === void 0 || _this$_docSelectionRe.onPaste$.pipe(takeUntil(this.dispose$)).subscribe((config) => {
			...
			const textContent = (_clipboardEvent$clipb2 = clipboardEvent.clipboardData) === null || _clipboardEvent$clipb2 === void 0 ? void 0 : _clipboardEvent$clipb2.getData(PLAIN_TEXT_CLIPBOARD_MIME_TYPE);
			const files = [...((_clipboardEvent$clipb3 = clipboardEvent.clipboardData) === null || _clipboardEvent$clipb3 === void 0 ? void 0 : _clipboardEvent$clipb3.items) || []].filter((item) => imageMimeTypeSet.has(item.type)).map((item) => item.getAsFile()).filter((e) => !!e);
...
let DocContextMenuRenderController = class DocContextMenuRenderController extends Disposable {
	...
	_initPointerDown() {
		...
		const documentsSubscription = ((_this$_context = this._context) === null || _this$_context === void 0 || (_this$_context = _this$_context.mainComponent) === null || _this$_context === void 0 ? void 0 : _this$_context.onPointerDown$).subscribeEvent((event) => {
			if (event.button === 2) this._contextMenuService.triggerContextMenu(event, ContextMenuPosition.MAIN_AREA);
		});
...
DocContextMenuRenderController = __decorate([__decorateParam(1, IContextMenuService), __decorateParam(2, ICommandService)], DocContextMenuRenderController);
	...
	_initRenderRefresher() {
		this._docSkeletonManagerService.currentSkeleton$.subscribe((param) => {
			...
			this.disposeWithMe(scene.onMouseWheel$.subscribeEvent((e) => {
				if (!e.ctrlKey || !this._contextService.getContextValue(FOCUSING_DOC)) return;
