...
- Xcode 16.0+
- Swift 5.9+
- A self-hosted TriliumNext server (**v0.95.x – v0.105.x** supported; native `/api` routes are pinned in `local_notes/trilium_native_api_v0.95.md`, with later-release deltas noted at the bottom of that file)
